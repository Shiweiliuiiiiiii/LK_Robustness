...
class SLakForERF(SLaK):
    ...
    def __init__(self,  kernel_size, width_factor=1, Decom=None,bn=True
                 ):
        super().__init__(in_chans=3, num_classes=1000,
                 depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], drop_path_rate=0.,
                 layer_scale_init_value=1e-6, head_init_scale=1., kernel_size=kernel_size, width_factor=width_factor, Decom=Decom,bn=bn)
