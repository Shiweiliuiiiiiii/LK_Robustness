...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/workspace/ssd1/shiwei/LK_distill/Table_1_CKS/',
...
def test_imagenet_c(distortion_name,
    ...
    for severity in severities:
        ...
        test_stats = evaluate(val_loader, model, device, use_amp=args.use_amp,data_type=args.data_type)
...
def main(args):
    ...
    if args.model=='resnet50':
        ...
        ck=torch.load(args.resume,map_location='cpu')['state_dict_ema']
        ...
        if args.data_type=='imagenet-c':
            ...
            with open(os.path.join(output_dir, 'eval_imagenet_c.txt'), 'w') as f:
                for distortion_name in imagenetc_distortions:
                    ...
                    #    continue
                    error_rate = test_imagenet_c(distortion_name,  model, device, args, val_transform, file=f)
