...
#distill from cswin
ck1=/ssd1/shiwei/LK_distill/Table_1_CKS/bnTrue_TeacherCSwin_STConvNext_NKD/checkpoint-best.pth
...
ck1=/ssd1/shiwei/LK_distill/Table_1_CKS/bnTrue_ConvNeXtTeacher_STconvnextv1_NKD/checkpoint-best.pth
python main_robust.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn True --Decom False  --resume $ck1 --input_size 224 --data_type $data_type --drop_path 0.1 --data_path $data
