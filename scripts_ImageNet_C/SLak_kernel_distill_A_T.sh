...
python main.py --model swin --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn True --Decom False  --resume $ck1 --data_type $data_type --input_size 224 --drop_path 0.1 --data_path $data

ck1=/gpfs/work3/0/prjste21060/projects/datasets/Table_1_CKS/T20_bnTrue_VitTeacher_STRN50_NKD/checkpoint-best.pth
python main.py --model vit --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn True --Decom False  --resume $ck1 --data_type $data_type --input_size 224 --drop_path 0.1 --data_path $data

ck1=/gpfs/work3/0/prjste21060/projects/datasets/Table_1_CKS/T20_bnTrue_VitTeacher_STRN50_NKD/checkpoint-best.pth
python main.py --model cswin --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn True --Decom False  --resume $ck1 --data_type $data_type --input_size 224 --drop_path 0.1 --data_path $data

ck1=/gpfs/work3/0/prjste21060/projects/datasets/checkpoints/convnext300epoch/checkpoint-best.pth
python main.py --model convnext --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn True --Decom False  --resume $ck1 --data_type $data_type --input_size 224 --drop_path 0.1 --data_path $data

ck1=./checkpoints/SLaK_tiny_checkpoint.pth
python main.py --model SLaK_tiny --eval True --kernel_size 51 49 47 13 5 --width_factor 1.3 --bn True --Decom True  --resume $ck1 --data_type $data_type --input_size 224 --drop_path 0.1 --data_path $data

ck1=/home/sliu/project_space/LoRA_LK/transfer/convnext_tiny/120epochs/checkpoint-best.pth
python main.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn True --Decom False  --resume $ck1 --data_type $data_type --input_size 224 --drop_path 0.1 --data_path $data
