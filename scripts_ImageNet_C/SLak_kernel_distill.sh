...
#SBATCH -o ./Slak_Robustness_imagenet_distillations.out
...
data=/home/sliu/project_space/datasets/imagenet-a
data_type=imagenet-a
# python  main.py --model SLaK_tiny --kernel_size 3 3 3 3 100 --width_factor 1.0 --eval True --Decom False  --resume /home/sliu/project_space/datasets/checkpoints/3x3/checkpoint-best.pth --input_size 224 --drop_path 0.1 --data_path /home/sliu/project_space/datasets/imagenet-a
# python  main.py --model SLaK_tiny  --kernel_size 5 5 5 5 100 --width_factor 1.0 --eval True --Decom False  --resume /home/sliu/project_space/datasets/checkpoints/5x5/checkpoint-best.pth --input_size 224 --drop_path 0.1 --data_path /home/sliu/project_space/datasets/imagenet-a
...
# python main.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --Decom False  --resume $chk1 --input_size 224 --drop_path 0.1 --data_path $data
# python main.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --Decom False  --resume $chk2 --input_size 224 --drop_path 0.1 --data_path $data
# python main.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --Decom False  --resume $chk3 --input_size 224 --drop_path 0.1 --data_path $data
# python main.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --Decom False  --resume $chk4 --input_size 224 --drop_path 0.1 --data_path $data
...
data_origin=/projects/2/managed_datasets/imagenet/

#ck1=/gpfs/work3/0/prjste21060/projects/datasets/T20_300/checkpoint-best.pth
#python main.py --model SLaK_tiny --eval True --kernel_size 7 7 7 7 100 --width_factor 1.0 --bn False --data_type $data_type --Decom False  --resume $ck1 --input_size 224 --drop_path 0.1 --data_path $data
